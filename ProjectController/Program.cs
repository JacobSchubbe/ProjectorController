...
builder.Services.AddSingleton<CommandRunner<ProjectorCommand, ProjectorCommandsEnum>>();
builder.Services.AddSingleton<CommandRunner<AndroidTVCommand, KeyCodes>>();
